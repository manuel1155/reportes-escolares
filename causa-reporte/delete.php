...
if ($id) {
    // Aplicamos tu lógica de borrado lógico
     $sql = "UPDATE causas SET activo = 0 WHERE id = :id";
...
<head>
    ...
    <title>Desactivando Causa de Reporte | CBTa 159</title>
    ...
    <div class="loader-content">
        <?php if ($success): ?>
            <script>
                ...
                setTimeout(() => {
                    Swal.fire({
                        title: 'Causa de Reporte Desactivado',
        ...
        <h5 class="status-text">Procesando baja de la Causa de Reporte...</h5>
